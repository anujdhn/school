...
class MasterController extends Controller
{
    ...
    **/
    ...
    public function addFinancialYear(Request $req){
        //Description: store master records
        $data = array();
        $validator = Validator::make($req->all(), [
    ...
    public function viewFinancialYear(){
        //Description: Get all records
        try {
    ...
    public function viewFinancialYearById(Request $req){ 
        //Description: Get records by id
        try {
    ...
    public function editFinancialYear(Request $req){
        //Description: edit records of a particular id
        try {
            $mObject = new FinancialYear();
            $data = $mObject->updateData($req);
    ...
    public function deleteFinancialYearById(Request $req){
        //Description: delete record of a particular id
        try {
            $mObject = new FinancialYear();
            $data = $mObject->deleteData($req);
    ...
    **/
    ...
    //  *      tags={"View Miscellaneous Category"},
    //  *      summary="View Miscellaneous Category",
    //  *      description="View Miscellaneous Category",
    //  *      @OA\RequestBody(
    //  *         required=true,
