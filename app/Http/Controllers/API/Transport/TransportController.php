...
//    //Pick Up Point API Start
//     /*
//     Created By : Lakshmi kumari 
//     Created On : 22-May-2023 
//     API: Pick Up Point CRUD
//     */
//     /**
//      *  @OA\Post(
//      *  path="/add_route",
...
//      *)
//     **/
//     public function addRoute1(Request $req){
//         //Description: store master records
//         try 
//          {
//             $data = array();
...
//       *  @OA\Property(property="data",type="object"))))
//      */
//      public function viewRoute1(Request $req){
//          //Description : Get all records
//          try {
//              $data = Route::list(); 
//              $mDeviceId = $req->deviceId ?? "";
...
//      public function viewRouteById1(Request $req){ 
//          //Description: Get records by id
//          try {
//              $listbyId = new Route();
//              $data  = $listbyId->listById($req);
...
//       *  )))
//      **/
//      public function editRoute1(Request $req){
//          //Description: edit records of a particular id 
//          try {
//              $mObject = new Route();
//              $data = $mObject->updateData($req);
...
//       * )))
//      **/
//      public function deleteRouteById1(Request $req){
//          //Description: delete record of a particular id
//          try {
//              $mObject = new Route();
//              $data = $mObject->deleteData($req);
...
//      public function deleteAllRoute1(Request $req){
//          //Description: delete all records 
//          // try {
//          //     $mObject = new Route();
//          //     $data = $mObject->truncateData();
