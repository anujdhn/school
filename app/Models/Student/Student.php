...
use App\Models\Student\StudentSibling;          // model
use App\Models\Admin\StudentTransport;          // model
...
class Student extends Model
{
    ...
    { 
      $checkExist = Student::where([['admission_no','=',$req->admissionNo],['is_deleted','=','0']])->count();
      $data = array(); 
      if($checkExist > 0){
